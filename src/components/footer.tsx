...
export const Footer = () => {
    ...
    return (
        <footer className="relative w-full bg-main text-white max-sm:overflow-hidden">
            <div
                className="absolute inset-0 pointer-events-none opacity-[0.05]"
                style={{
                    backgroundImage: `linear-gradient(#fff ${mobile ? 2 : 4}px, transparent ${mobile ? 2 : 4}px), linear-gradient(90deg, #fff ${mobile ? 2 : 4}px, transparent ${mobile ? 2 : 4}px)`,
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 pt-8">
                <div className="mb-6 lg:static lg:left-auto lg:translate-x-0">
                ...
                <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <address className="not-italic text-base leading-tight text-teal-50">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="space-y-3 text-sm text-teal-50">
                            <div className="flex flex-col space-y-1">
                                ...
                                <a href="mailto:gmerino@cinvestav.mx" className="hover:text-blue-200 transition font-semibold w-fit">gmerino@cinvestav.mx</a>
                                ...
                                <a href="mailto:filiberto.ortiz@cinvestav.mx" className="hover:text-blue-200 transition font-semibold w-fit">filiberto.ortiz@cinvestav.mx</a>
                            ...
                            <div className="flex flex-col space-y-1">
                                ...
                                <p>Gabriel: (+52) 999 942 94 00 - Ext 2591</p>
                                <p>Lab: (+52) 999 942 94 00 - Ext 2576</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="space-y-3">
                            <a href="https://twitter.com/theochemmerida" target="_blank" rel="noreferrer" className={cn(
                                "flex items-center gap-2 text-sm text-teal-50 w-45 font-semibold border-2 border-teal-50 py-1 px-3 rounded-2xl",
                                "transition hover:text-blue-200 hover:border-blue-200",
                                "hover:translate-x-1 hover:scale-105 origin-right",
                            )}>
                            ...
                            <a href="http://scholar.google.com/citations?user=qRD50m4AAAAJ&hl=es" target="_blank" rel="noreferrer" className={cn(
                                "flex items-center gap-2 text-sm text-teal-50 w-45 font-semibold border-2 border-teal-50 py-1 px-3 rounded-2xl",
                                "transition hover:text-blue-200 hover:border-blue-200",
                                "hover:translate-x-1 hover:scale-105 origin-right",
                            )}>
                        ...
                        <div className='space-y-[0.5]'>
                            ...
                            {[
                                ...
                                <p
                                    key={index}
                                    className={cn(
                                        "text-sm leading-relaxed text-teal-50 cursor-pointer",
                ...
                <div className="text-center font-semibold text-xs text-teal-50 pb-5">
